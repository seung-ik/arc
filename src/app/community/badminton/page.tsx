...
const mockPosts = [
  ...
  },
  {
    ...
    content: '배드민턴 더블스 파트너를 구합니다. 중급 실력이고 주말에 자주 치실 분 찾습니다.',
    authorId: 'user789',
    authorName: '배드민턴마스터',
    date: '2024-01-12',
    category: 'badminton',
  ...
  },
  {
    ...
    content: '배드민턴 연습 상대를 구합니다. 초보자도 환영하고 함께 실력 향상하실 분 찾습니다.',
    authorId: 'user202',
    authorName: '배드민턴학도',
    date: '2024-01-09',
    category: 'badminton',
  ...
  },
  {
    ...
    content: '배드민턴 실력을 더욱 향상시키고 싶습니다. 고급 기술과 전략을 배우고 싶어요.',
    authorId: 'user505',
    authorName: '배드민턴학도',
    date: '2024-01-02',
    category: 'badminton',
